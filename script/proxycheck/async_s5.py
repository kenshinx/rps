...
S5_STATE_REQ = 3
S5_STATE_RESP = 4
S5_STATE_PAYLOAD_REQ = 5
S5_STATE_PAYLOAD_RESP = 6
S5_STATE_CLOSED = 7
...
if __name__ == "__main__":
    ...
    for line in sys.stdin:
        ...
        clients.append(AsyncSocks5Client(host, port, WHOIS_HOST, WHOIS_PORT, "whois", socket_map))
        #clients.append(AsyncSocks5Client(host, port, HTTP_HOST, HTTP_PORT, "http", socket_map))
